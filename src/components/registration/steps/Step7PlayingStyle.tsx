...
export default function Step7PlayingStyle({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 className="text-xl font-bold text-white">Playing Style & Motivation</h2>
      ...
      <Card className="flex flex-col gap-4">
        <TextArea
          ...
          placeholder="Tell us about yourself as a football player. What is your story?"
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <TextArea
            ...
            required
            rows={3}
            helperText="What are your key strengths on the pitch?"
            id="strengths"
          />
      ...
      <Card className="flex flex-col gap-4">
        <TextArea
          ...
          required
          rows={2}
          helperText="Where do you see yourself in 5 years?"
          id="career-goal"
        />
        ...
        <TextArea
          ...
          required
          rows={3}
          helperText="What motivates you to play professionally?"
          id="motivation"
        />
      </Card>
    </div>
