      ...
      <section className="pb-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          {[
            ...
            { title: "4. Specific Cookies We Set", content: "next-auth.session-token: Essential cookie for maintaining your login session. Set when you log in, expires when you log out or the session expires.\n\nnext-auth.csrf-token: Essential cookie for security, preventing cross-site request forgery attacks.\n\nproscout-registration: Local storage item used to save your progress during the registration wizard. Cleared upon successful submission.\n\n_ga, _gid: Google Analytics cookies that help us understand how visitors use our platform." },
