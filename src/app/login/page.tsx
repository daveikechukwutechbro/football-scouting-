    ...
    <section className="min-h-screen flex items-center justify-center bg-[#0A0A0F] px-6">
      <div className="w-full max-w-[380px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[22px] font-bold text-[#F1F5F9]">Welcome back</h1>
          <p className="text-[13px] text-[#636681] mt-1">Sign in to your ProScout account</p>
        </div>

        <div className="p-6 rounded-xl bg-[#111118] border border-white/[0.04]">
          {error && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-red-500/[0.06] border border-red-500/[0.12] mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-[14px] font-semibold text-white bg-[#10B981] hover:bg-[#0EA573] transition-all duration-200 disabled:opacity-50"
            >
        ...
        <p className="mt-6 text-center text-[13px] text-[#475569]">
          ...
          <Link href="/register" className="text-[#10B981] hover:text-[#38BDF8] font-medium transition-colors">
            Register now
          </Link>
        </p>
      </div>
